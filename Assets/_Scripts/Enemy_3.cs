...
public class Enemy_3 : Enemy
{
    ...
    [Tooltip("If true, the bezier points and path are drawn in the scene plane")]
    public bool drawDebugInfo = true;
    [Header("Enemy 3 private fields")]
    [SerializeField]
    ...
    void Start()
    {
        ...
        points[1].x = Random.Range(midpointYRange[0], midpointYRange[1]);
    ...
    public override void Move()
    {
        ...
        //Interpolatre the three Bezier curves
